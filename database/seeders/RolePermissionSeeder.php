...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissionsByModule = [
            ...
            'kemahasiswaan' => ['view', 'create', 'edit', 'delete', 'verify'],
        ...
        $roles = [
            ...
            'WR 1 Akademik' => ['master-data' => ['view'], 'portofolio' => ['view'], 'bkd' => ['view'], 'akreditasi' => ['view'], 'kurikulum' => ['view'], 'kemahasiswaan' => ['view'], 'data-import' => ['download-template', 'view']],
            ...
            'WR 3 Kemahasiswaan' => ['kemahasiswaan' => ['view', 'create', 'edit', 'delete', 'verify'], 'master-data' => ['view'], 'laporan' => ['view', 'export'], 'agent-ai' => ['view'], 'data-import' => ['download-template', 'view']],
            'LPM' => array_merge([
                'master-data' => ['view'],
                'akreditasi' => ['view', 'edit', 'generate'],
                'spmi' => ['view', 'create', 'edit', 'delete'],
            ...
            'Dosen' => ['portofolio' => ['view', 'create', 'edit'], 'bkd' => ['view', 'create'], 'dokumen' => ['view', 'upload'], 'kemahasiswaan' => ['view'], 'data-import' => ['download-template', 'view'], 'rkat' => ['view'], 'iku' => ['view']],
