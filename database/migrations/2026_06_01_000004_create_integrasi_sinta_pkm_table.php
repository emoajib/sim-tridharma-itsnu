...
return new class extends Migration
{
    ...
    {
        Schema::create('integrasi_sinta_pkm', function (Blueprint $table) {
            $table->id();
            $table->foreignId('dosen_id')->nullable()->constrained('m_dosen')->nullOnDelete();
            $table->foreignId('pkm_id')->nullable()->constrained('trx_pkm')->nullOnDelete();
            $table->text('judul');
    ...
    {
        Schema::dropIfExists('integrasi_sinta_pkm');
    }
};
