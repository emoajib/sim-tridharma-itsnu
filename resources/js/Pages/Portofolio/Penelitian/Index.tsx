                                    ...
                                    {penelitian.data.length === 0 ? (
                                        ...
                                        penelitian.data.map((item) => (
                                            <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-sm text-gray-700 leading-relaxed">{item.judul_penelitian}</td>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                    <div className="w-full max-w-lg rounded-lg bg-white p-6 shadow-xl">
                        <div className="mb-4 flex items-center justify-between border-b pb-3">
                            <h3 className="text-lg font-bold text-gray-900">{editing ? 'Edit Penelitian' : 'Tambah Penelitian'}</h3>
                        ...
                        <form onSubmit={submit}>
                            <div className="grid grid-cols-1 gap-4">
                                ...
                                <div>
                                    <label className="mb-1 block text-sm font-bold text-gray-700">Judul Penelitian</label>
                                    <textarea rows={2} value={data.judul_penelitian} onChange={(e) => setData('judul_penelitian', e.target.value)} className="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500"></textarea>
                                    {errors.judul_penelitian && <p className="mt-1 text-xs text-red-600 font-bold">{errors.judul_penelitian}</p>}
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="mb-1 block text-sm font-bold text-gray-700">Jenis</label>
                                        <select value={data.jenis_penelitian} onChange={(e) => setData('jenis_penelitian', e.target.value)} className="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="mb-1 block text-sm font-bold text-gray-700">Sumber Dana</label>
                                        <input type="text" value={data.sumber_dana} onChange={(e) => setData('sumber_dana', e.target.value)} className="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500" />
                                    </div>
                                    <div>
            ...
            {deleteTarget && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                    <div className="w-full max-w-sm rounded-lg bg-white p-6 shadow-xl border-2 border-rose-500">
                        ...
                        <p className="mb-6 text-sm text-gray-700 font-medium">Yakin ingin menghapus penelitian:<br/><span className="italic font-bold">"{deleteTarget.judul_penelitian}"</span>?</p>
